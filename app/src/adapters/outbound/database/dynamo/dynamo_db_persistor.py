...
from app.src.adapters.outbound.database.dynamo.config.dynamo_db_config import DynamoDBConfig
from app.src.adapters.outbound.database.dynamo.mappers.message_out_db_mapper import MessageOutDBMapper
from app.src.application.ports.outbound.persistor_message import PersistorMessage
from botocore.exceptions import BotoCoreError, ClientError

from app.src.common.properties_env import dynamodb_table_name
